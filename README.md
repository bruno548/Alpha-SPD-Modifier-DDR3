...
1. **Baixar o Software:** Você pode utilizar o script bruto rodando `python spd.py` (necessita do Tkinter instalado) ou executar diretamente o arquivo independente **`AH_SPD.exe`**.
